...
- ⬜（後續 dated 收錄：ChatGPT Faithfulness packet → ④ → merge-front 7 gates → MERGE_ALLOWED → squash → 監看 main CI + Cloudflare deploy → SHIPPED memory）
