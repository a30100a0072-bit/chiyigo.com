...
- **授權邊界**：③ code gate 過 **≠ push / merge / ④ faithfulness**；仍待 **④ ChatGPT faithfulness** + owner 明示才進 main（squash-merge）。
