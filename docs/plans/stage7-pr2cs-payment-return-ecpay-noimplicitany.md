...
- ⬜（後續 dated 收錄：Codex Code packet〔HEAD-independent anchor〕 → ③ Codex Code → ④ ChatGPT Faithfulness → merge-front 7 gates → owner `MERGE_ALLOWED` → squash → SHIPPED）
