...
- （後續 dated 收錄：plan doc commit → ChatGPT Arch → Codex Plan → CODING_ALLOWED → Code → Code self-review → Codex Code → ChatGPT Faithfulness → merge-front 7 gates → MERGE_ALLOWED → SHIPPED）
