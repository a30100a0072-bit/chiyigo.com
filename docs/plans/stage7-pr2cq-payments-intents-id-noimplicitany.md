...
- （後續 dated 收錄：Codex Code packet → ③ Codex Code → ChatGPT Faithfulness packet → ④ ChatGPT Faithfulness → merge-front 7 gates → owner `MERGE_ALLOWED` → squash-merge → SHIPPED）
