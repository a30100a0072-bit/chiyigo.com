...
- `elder_relationships`：`tenant_id`、`elder_user_id(sub)`、`caregiver_user_id(sub)`、`role`、`permissions(JSON: view_health|manage_schedule|emergency_contact)`、`expires_at`、`created_at`、`revoked_at`
