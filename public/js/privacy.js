// Stage 5 PR-4 (2026-05-21)：page-scoped entry 必須 IIFE 包頂層 code，
...
(function () {
    ...
    function applyLangI(lang) {
        ...
        if (dis)
            dis.classList.toggle('show', lang !== 'zh-TW');
