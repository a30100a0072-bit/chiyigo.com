...
(function () {
    ...
    function ssoifyLink(linkUrl) {
        ...
        if (email)
            u.searchParams.set('mbti_email', email);
        return u.toString();
    }
    ...
    function applyLang(lang) {
        ...
        CAT_LABEL['Web'] = t.cat_web;
        CAT_LABEL['System'] = t.cat_system;
        CAT_LABEL['AI'] = t.cat_ai;
        CAT_LABEL['Analytics'] = t.cat_analytics;
        CAT_LABEL['App'] = t.cat_app;
        CAT_LABEL['Integration'] = t.cat_integration;
