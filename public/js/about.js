// Stage 5 PR-5f (2026-05-22)：page-scoped entry 必須 IIFE 包頂層 code，
...
// osContent / revRoot / revObs / tlWrap）在同 tsc program 全域 scope 撞名 →
// TS2393。內層 drag-to-close / neural-canvas 既有 IIFE 維持不動。
;
(function () {
    // ── block 1/2 ──
    // ── Mobile overlay ──────────────────────────────────────────
