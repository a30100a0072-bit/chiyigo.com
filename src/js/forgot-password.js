const I18N = {
  'zh-TW': {
    title:'忘記密碼', subtitle:'輸入註冊信箱，我們將寄送重設連結',
    ...
    ts_loading_hint:'資安驗證準備中，可先填寫帳號',
    loading:'送出中…', err_generic:'請求失敗，請稍後再試。', err_network:'網路錯誤，請檢查連線後重試。',
    err_captcha_pending:'請先完成人機驗證。',
  },
  en: {
    title:'Forgot Password', subtitle:'Enter your registered email; we will send a reset link.',
    ...
    ts_loading_hint:'Loading security check; you can fill the form first',
  ...
  ja: {
    title:'パスワードをお忘れですか', subtitle:'登録メールアドレスを入力してください。再設定リンクをお送りします。',
  ...
  ko: {
    ...
    ts_loading_hint:'인증 준비 중, 먼저 입력 가능',
