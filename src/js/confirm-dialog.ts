...
interface Window {
  confirmDialog: (opts?: ConfirmDialogOpts) => Promise<boolean>
}

;(function () {
  'use strict'
  let openDialog: { close: (result: boolean) => void } | null = null

  function getFocusables(root: HTMLElement): NodeListOf<HTMLElement> {
